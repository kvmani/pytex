...
def score_parent_orientations(
    ...
    *,
    ...
    Shared internal scoring primitive for the stable bounded candidate report and
    the experimental facade. Map-scale reconstruction is not promoted by this reuse.
