...
# Every test here starts from a phase loaded out of its CIF fixture, which
# pymatgen parses. It is a required dependency, so this module runs in every
# lane rather than being skipped in some of them.
