# Phase-Transformation Relationship Construction From Plane-Direction Correspondence
...
- a parent-plane normal in the parent crystal frame
- a child-plane normal in the child crystal frame
- a parent direction in the parent crystal frame
- a child direction in the child crystal frame
...
- The parent plane and parent direction must belong to the same parent phase.
- The child plane and child direction must belong to the same child phase.
- The projected direction must not become degenerate after projection into the plane.
- The constructor currently treats one plane plus one direction as the defining evidence. It does not yet reconcile redundant, noisy, or conflicting correspondence sets.
...
## Current Named Example: Nishiyama–Wassermann
