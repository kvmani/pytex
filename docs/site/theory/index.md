...
- read the LaTeX notes when you need convention fixing, mathematical detail, or algorithm assumptions
- treat these notes as canonical when the web pages deliberately summarize rather than repeat full derivations
...
- [../../tex/algorithms/dynamical_cbed_and_symmetry_determination.tex](../../tex/algorithms/dynamical_cbed_and_symmetry_determination.tex)
