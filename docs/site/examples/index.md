...
| `stress-isotropic-half-s2` | 6.0952 | 6.0952 | TPa^-1 | ✅ |
| `stress-reuss-ferrite-211` | 5.8070 | 5.8069 | TPa^-1 | ✅ |
| `stress-kroener-shear-modulus-ferrite` | 82.448 | 82.448 | GPa | ✅ |
| `stress-sin2psi-slope-identity` | -2.03615 | -2.03615 | mÅ | ✅ |
| `stress-strain-free-direction` | 0.4375 | 0.4375 | &mdash; | ✅ |
| `stress-in-plane-principal` | -133.381 | -133.381 | MPa | ✅ |
| `stress-end-to-end-ferrite` | -350.1 | -350.0 | MPa | ✅ |
| `stress-excluding-a-bad-point` | 60.000000 | 60.000000 | MPa | ✅ |
| `xray-wavelength-from-photon-energy` | 0.4132807 | 0.4132807 | angstrom | ✅ |
| `xray-polarization-factor-synchrotron` | 0.4600 | 0.4600 | &mdash; | ✅ |
...
| `hrem-astigmatism-equivalent-defocus` | [0.00e+00, 0.00e+00] | [0.00e+00, 0.00e+00] | Å | ✅ |
| `hrem-astigmatic-resolution-split` | 90.0 | 90.0 | deg | ✅ |
| `multislice-projected-potential-integral` | 279.414 | 279.414 | V Å^3 | ✅ |
| `multislice-silicon-mean-inner-potential` | 13.954 | 13.954 | V | ✅ |
| `multislice-band-limit-scattering-angle` | 167.196 | 167.196 | mrad | ✅ |
| `multislice-defocus-is-fresnel-propagation` | < 1e-12 | 0.0e+00 | &mdash; | ✅ |
| `multislice-agrees-with-bloch-waves` | 0.0004 | 0.0000 | &mdash; | ✅ |
| `multislice-focal-integration-reproduces-frank-envelope` | 0.17881 | 0.17881 | &mdash; | ✅ |
...
- {doc}`Multislice HRTEM simulation <generated/multislice-hrtem>` &mdash; The multislice engine against closed forms and a second method: the absolute scale of the projected potential and the mean inner potential, the band limit, defocus as Fresnel propagation, agreement with Bloch waves on the same potential, and focal integration against Frank's envelope.
