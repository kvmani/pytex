...
\subsection{Double Diffraction And Forbidden Reflections}
...
\begin{itemize}
  ...
  \item Double diffraction supplies the correct \emph{set} of extra reflections, but their intensities are a coupling estimate, not a solved multi-beam calculation.
\end{itemize}
