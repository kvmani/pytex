...
The \emph{equal-volume} representations --- homochoric and cubochoric --- are not covered here; they, the invariant-measure argument that motivates them, and the inverse construction that recovers $(hkl)[uvw]$ indices from an orientation are in 	exttt{docs/tex/theory/orientation\_representations.tex}.
