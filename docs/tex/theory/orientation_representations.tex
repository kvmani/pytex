...
Here \(\boldsymbol{\rho}\) is the Rodrigues vector, \(\boldsymbol{\rho}_{F}\) its homogeneous
(Frank) form, which stays finite as \(\omega \to \pi\), and \(\mathbf{h}\) the homochoric
vector. Euler angles follow the axis sequences of
