...
- plotting validation tied to structural runtime figure assertions
- phase-transformation validation tied to variant prediction and experimental parent scoring
